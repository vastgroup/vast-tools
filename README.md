...
``vast-tools compare`` identifies differentially spliced AS events between two groups (A and B) solely based on the difference in their average inclusion levels (i.e. dPSI = average_PSI_B - average_PSI_A). 
